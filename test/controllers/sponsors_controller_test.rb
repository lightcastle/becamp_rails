...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { homepage_url: @sponsor.homepage_url, logo_url: @sponsor.logo_url, sequence: @sponsor.sequence, width: @sponsor.width }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { homepage_url: @sponsor.homepage_url, logo_url: @sponsor.logo_url, sequence: @sponsor.sequence, width: @sponsor.width }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
